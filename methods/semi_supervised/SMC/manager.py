...
from .pretrain import PretrainSMCManager
...
class SMCManager:
    ...
    def __init__(self, args, data, model):
        ...
        pretrain_manager = PretrainSMCManager(args, data, model)
        ...
        self.train_labeled_mmdata = data.train_labeled_mmdata
        self.train_unlabeled_dataloader = data.train_unlabeled_dataloader
        self.train_unlabeled_mmdata = data.train_unlabeled_mmdata
        # 合并的形式
        self.train_dataloader, self.test_dataloader = data.train_dataloader, data.test_dataloader
